...
def difference_reward_mod(sim):
    ...
    # Agent Reward 
    sim.data["Reward Function"] = calc_difference_reward
...
def dpp_reward_mod(sim):
    ...
    # Agent Reward 
    sim.data["Reward Function"] = calc_dpp_reward
